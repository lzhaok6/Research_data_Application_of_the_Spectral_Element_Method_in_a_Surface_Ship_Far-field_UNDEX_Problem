...
plot(algo4_N2_srs(:,1), algo4_N2_srs(:,2),'-r','LineWidth',0.5);
hold on
plot(algo5_N2_srs(:,1), algo5_N2_srs(:,2),'-.b','LineWidth',0.5);
% hold on
% plot(hex_algo2_N4(:,1), hex_algo2_N4(:,2),'--g','LineWidth',0.5);
% hold on 
% plot(hex_7e_7(:,1), hex_7e_7(:,2),'--g','LineWidth',0.5);
% hold on 
% plot(hex_0_05(:,1), hex_0_05(:,2),'-.g','LineWidth',0.5);
% hold on 
% plot(hex_0_02(:,1), hex_0_02(:,2),'-r','LineWidth',0.5);
% hold on
% plot(sph_3_5ms(:,1), sph_3_5ms(:,2),'--g','LineWidth',0.5);
% hold on
% plot(sph_4ms(:,1), sph_4ms(:,2),'-m','LineWidth',0.5);
% hold on 
% plot(sph_4_5ms(:,1), sph_4_5ms(:,2),'-k','LineWidth',0.5);
% hold on
% plot(sph_5ms(:,1), sph_5ms(:,2),'-c','LineWidth',0.5);
% hold on 
% plot(sph_5_5ms(:,1), sph_5_5ms(:,2),'-y','LineWidth',0.5);
...
%lg=legend('N2','N3','Location','northeast');
set(lg,'FontSize',5) 
xlim([0,300]); 
% ylim([-2,6])
% lb1=xlabel('time (s)');
