...
plot(algo1_srs(:,1), algo1_srs(:,2),'-r','LineWidth',0.5);
hold on
plot(algo5_srs(:,1), algo5_srs(:,2),'-.b','LineWidth',0.5);
% hold on
...
lg=legend('Conservative scheme','Consistent scheme','Location','south');
