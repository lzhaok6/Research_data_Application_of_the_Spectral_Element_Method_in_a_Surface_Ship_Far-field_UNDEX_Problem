...
plot(Abaqus1646(:,1),Abaqus1646(:,2),'-r','LineWidth',0.5);
hold on 
plot(Inhouse1646(:,1),Inhouse1646(:,2),'-.b','LineWidth',0.5);
% hold on 
...
lg=legend('Abaqus','Inhouse fluid and FSI','Location','northeast');
set(lg,'FontSize',7)
lb1=xlabel('time (s)');
lb2=ylabel('velocity (m/s)');
set(lb1,'FontSize',20);
